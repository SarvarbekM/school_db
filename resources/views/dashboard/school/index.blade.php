...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-heading-btn">
                <a href="{{route('dashboard.school.arcade',['id'=>0])}}" class="btn btn-xs btn-success m-l-10"
        ...
        <div class="panel-body">
            <!-- begin Search panel -->
            <form class="m-b-20" method="get" name="search_form" action="{{route('dashboard.school.index')}}">
                <div class="form-row">
                    <div class="col">
                ...
                @foreach($objects as $item)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <a title="Tahrirlash" href="{{route('dashboard.school.arcade',['id'=>$item->id])}}"
    ...
    @include('includes.school.delete_modal')
@endsection
