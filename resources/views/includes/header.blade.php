...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		...
		@endif
		<a href="index.html" class="navbar-brand"><span class="navbar-logo"></span> <b>SCHOOL</b> DB</a>
		@if ($headerMegaMenu)
...
{{--				<img src="/assets/img/user/user-13.jpg" alt="" />--}}
				<span class="d-none d-md-inline">{{$current_user->first_name.' '.$current_user->last_name}}</span> <b class="caret"></b>
			</a>
			<div class="dropdown-menu dropdown-menu-right">
				<a href="{{route('dashboard.profile')}}" class="dropdown-item">Sozlamalar</a>
{{--				<a href="javascript:;" class="dropdown-item"><span class="badge badge-danger pull-right">2</span> Inbox</a>--}}
				<a href="{{route('dashboard.about')}}" class="dropdown-item">Dastur haqida</a>
